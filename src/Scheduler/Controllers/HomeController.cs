...
namespace Love.Net.Scheduler.Controllers {
    ...
    public class HomeController : Controller {
        ...
        [Route("/jobs/{pageIndex:int}/{pageSize:int}")]
        public object jobs(int pageIndex, int pageSize) {
            using (var connection = JobStorage.Current.GetConnection()) {
        ...
        [HttpGet]
        public IEnumerable<object> cron() {
            var items = new[]
                 {
        ...
        [HttpPost]
        public void jobs([FromBody]CreateDto createDto) {
        ...
        [HttpPut]
        public bool update([FromBody]UpdateDto updateDto) {
        ...
        [HttpGet]
        public IEnumerable<object> symbol() {
            var items = new[]
                {
